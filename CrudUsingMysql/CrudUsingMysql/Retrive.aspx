<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Retrive.aspx.cs" Inherits="CrudUsingMysql.Register" %>
...
<body>
    <form id="form1" runat="server">
        <div class="grid-style">
            ...
            <asp:GridView ID="gvStudent" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" Width="557px" OnRowCommand="gvStudent_RowCommand">
                <Columns>
